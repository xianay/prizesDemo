...
/**
 * 3d 直选复式
 * <br>例：1,2:3,4:5,6 (百，十，个)
 * @author anyi
 *
 */
public class D3ZXFSAwardProcesser extends AwardProcesserImpl implements D3AwardProcesser{
	...
	public boolean validation(String lottery_number) {
		...
		return lottery_number.matches("[0-9]+([,][0-9])*[:]{1}[0-9]+([,][0-9])*[:]{1}[0-9]+([,][0-9])*");
	}
