 ...
 * 3d 组选6投注兑奖
 * <br>例：
 * <br>1.组六复式  1,2,3,4 从[0-9]中任选(4~10)个号码进行组选六的投注。
 * <br>2.跨度组选六 ~2 所有跨度相同的组六。
 * @author anyi
 *
 */
@Deprecated
public class D3ZuX6AwardProcesser  extends AwardProcesserImpl implements AwardProcesser {
