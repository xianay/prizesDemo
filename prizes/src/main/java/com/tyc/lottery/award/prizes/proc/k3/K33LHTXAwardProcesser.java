 ...
 *
 */
public class K33LHTXAwardProcesser extends AwardProcesserImpl implements K3AwardProcesser{
	...
	public List<Award> prize(String openNum, String lottery_number)
		...
		if(lottery_number.matches("([0][,]){2}[0]")){									
			...
			Award award = AwardUtils.prizewinning_K3(lottery_number.split(","), open, AwardUtils.K3_三连号通选);		
			if (award != null)
				list.add(award);
			return list;
		}
